  ...
  return (
    <div className="flex flex-col rounded-xl border border-border bg-card transition-all hover:shadow-sm">
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex min-w-0 flex-1 items-start gap-3">
            ...
            <div className="min-w-0 flex-1">
              <h3 className="truncate text-base font-semibold text-text" title={agent.name}>
                {agent.name}
              </h3>
              {agent.role && (
                <p className="mt-0.5 truncate text-sm text-muted">{agent.role}</p>
              )}
            </div>
          </div>
      ...
      <div className="px-5 pb-4">
        {linkedInbox ? (
          <div className="flex items-center justify-between gap-2 rounded-lg border border-success/25 bg-success/5 px-3 py-2.5 sm:px-4">
            <div className="flex min-w-0 flex-1 items-center gap-2.5">
              ...
              <div className="min-w-0">
                ...
                <span
                  className="ml-1.5 text-xs text-success/70"
                  title={linkedInbox.name ?? linkedInboxId ?? undefined}
                >
            ...
            <button
              ...
              disabled={acting}
              className="flex shrink-0 items-center gap-1.5 rounded-md border border-transparent px-2 py-1.5 text-xs font-medium text-muted transition-colors hover:border-danger/30 hover:bg-danger/5 hover:text-danger sm:px-2.5"
